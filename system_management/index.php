        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <!-- Navbar items go here (no login/signup buttons) -->
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="col">
                    <div class="card h-100 text-center border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <h5 class="card-title mt-3">Event Listing</h5>
                ...
                <div class="col">
                    <div class="card h-100 text-center border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-secondary" style="color: #6f42c1; border-color: #6f42c1;">Find Help</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100 text-center border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-warning">Give Feedback</a>
                        </div>
                    </div>
                </div>
            </div>
